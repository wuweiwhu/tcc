...
Parser<LexerPolicy, ParserPolicy>::Parser(const std::string &filePath, std::ostream &errOut)
    : m_lexerImpl(new LexerPolicy(filePath)), m_parserImpl(new ParserPolicy(errOut)) {
}
...
template class Parser<lexer::Lexer, LRParser>;
